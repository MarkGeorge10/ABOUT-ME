...
<h3 align="center">Energetic software engineer with 2 years of experience especially in mobile development, and back-end development area which enable me to create software that adds business value to you as well as I am entry-level Data Scientist with strong mathematics background and 1+ years of experience using predictive modeling, data processing, and data mining algorithms to solve challenging business problems. Involved in Python open-source community and passionate about deep reinforcement learning. Recently completed the Google Data Analytics Processional Certificate to enhance my knowledge and create meaningful insights returning with recommendations to the top management.</h3>
...
- Cyclitic Google Capstone Project
